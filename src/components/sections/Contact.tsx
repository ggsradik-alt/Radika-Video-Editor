        ...
        <div className="flex flex-col gap-6 w-full md:w-auto">
          ...
          >
            <div>
              ...
              <p className="text-xl md:text-3xl font-heading font-bold text-text-main group-hover:text-accent-red transition-colors">hello@radika.com</p>
            </div>
          ...
          >
            <div>
              ...
              <p className="text-xl md:text-3xl font-heading font-bold text-text-main group-hover:text-accent-red transition-colors">+62 812 3456</p>
            </div>
            <ArrowRight size={32} className="text-text-dim group-hover:text-accent-red group-hover:translate-x-2 transition-all" />
          </a>
        </div>
